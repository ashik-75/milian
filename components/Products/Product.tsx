...
function Product({ product }: ProductProps) {
  return (
    <div className="p-3 rounded">
      ...
      <h4 className="font-semibold text-lg mt-1">{product?.title}</h4>
    </div>
  );
}
